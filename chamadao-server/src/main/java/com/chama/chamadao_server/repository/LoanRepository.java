...
public interface LoanRepository extends JpaRepository<Loan, Long> {
    ...
    List<Loan> findByChamaAddress(String chamaAddress);
    ...
    @Query("SELECT l from Loan l LEFT JOIN FETCH l.chama LEFT JOIN FETCH l.borrower WHERE l.chama.walletAddress = :chamaAddress")
